...
//		session.setAttribute("username","Amisha");
				
//		out.print("<html>");
//		out.print("<body bgcolor=\"lightgrey\"><h1> Hello! </h1></body>");
//		out.print("</html>");
...
//	
		...
		out.print("<body bgcolor=\"lightgrey\"><h1> End of Servlet </h1></body>");
		
		
		//share information with request scope variables
//		ServletContext sc = getServletContext();
//		sc.setAttribute("userame","Amisha");
//	
